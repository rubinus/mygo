...
import (
	"fmt"
	"mygo/data-str/14-Hash-Table/06-Resizing-in-Hash-Table/src/AVLTree"
	"mygo/data-str/14-Hash-Table/06-Resizing-in-Hash-Table/src/BSTMap"
	"mygo/data-str/14-Hash-Table/06-Resizing-in-Hash-Table/src/FileOperation"
	"mygo/data-str/14-Hash-Table/06-Resizing-in-Hash-Table/src/HashTable"
	"mygo/data-str/14-Hash-Table/06-Resizing-in-Hash-Table/src/RBTree"
	"path/filepath"
	"time"
)
...
func main() {
	...
	filename, _ := filepath.Abs("14-Hash-Table/06-Resizing-in-Hash-Table/pride-and-prejudice.txt")
