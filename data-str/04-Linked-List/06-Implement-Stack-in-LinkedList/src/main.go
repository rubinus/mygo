...
import (
	"fmt"
	"math/rand"
	"mygo/data-str/04-Linked-List/06-Implement-Stack-in-LinkedList/src/ArrayStack"
	"mygo/data-str/04-Linked-List/06-Implement-Stack-in-LinkedList/src/LinkedListStack"
	"mygo/data-str/04-Linked-List/06-Implement-Stack-in-LinkedList/src/Stack"
	"time"
)
