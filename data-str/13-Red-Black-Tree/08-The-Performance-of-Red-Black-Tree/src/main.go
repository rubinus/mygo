...
import (
	...
	"mygo/data-str/13-Red-Black-Tree/08-The-Performance-of-Red-Black-Tree/src/FileOperation"
...
func main() {
	...
	filename, _ := filepath.Abs("data-str/13-Red-Black-Tree/08-The-Performance-of-Red-Black-Tree/pride-and-prejudice.txt")
