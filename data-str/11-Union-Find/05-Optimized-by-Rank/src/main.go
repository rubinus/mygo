...
import (
	"fmt"
	"math/rand"
	"mygo/data-str/11-Union-Find/05-Optimized-by-Rank/src/UF"
	"mygo/data-str/11-Union-Find/05-Optimized-by-Rank/src/UnionFind3"
	"mygo/data-str/11-Union-Find/05-Optimized-by-Rank/src/UnionFind4"
	"time"
)
