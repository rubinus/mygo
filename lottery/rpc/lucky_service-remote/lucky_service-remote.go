...
func main() {
	...
	case "DoLucky":
		if flag.NArg()-1 != 6 {
			fmt.Fprintln(os.Stderr, "DoLucky requires 6 args")
			flag.Usage()
		}
		...
		value2 := argvalue2
		argvalue3, err10 := (strconv.ParseInt(flag.Arg(4), 10, 64))
		if err10 != nil {
			Usage()
			return
		}
		...
		value5 := argvalue5
		fmt.Print(client.DoLucky(context.Background(), value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	case "MyPrizeList":
		if flag.NArg()-1 != 6 {
			fmt.Fprintln(os.Stderr, "MyPrizeList requires 6 args")
			flag.Usage()
		}
		...
		argvalue2 := flag.Arg(3)
		value2 := argvalue2
		argvalue3, err16 := (strconv.ParseInt(flag.Arg(4), 10, 64))
		if err16 != nil {
			Usage()
			return
		}
		...
		argvalue5 := flag.Arg(6)
		value5 := argvalue5
		fmt.Print(client.MyPrizeList(context.Background(), value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	case "":
		Usage()
